...
import { HomeOutlined, CheckCircleOutlined, ContainerOutlined } from '@ant-design/icons';
import { PageHeader } from '../../components';  // Assuming you have a PageHeader component
            ...
            <Row justify="center">
                <Col xs={24} sm={18} md={12} lg={10}>
                    ...
                    >
                        ...
                        <Text style={{ fontSize: '16px', display: 'block', marginBottom: '16px' }}>
                            Grading will be available soon. Please check back later for your results.
                        </Text>
