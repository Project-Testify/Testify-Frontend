...
export const CandidateOngoingExams = () => {
  const exams = [
    { id: 1, name: "Compiler Theory Flex & Bison", status: "ongoing", code: "S102" },
    { id: 2, name: "Machine Learning - Quiz 3", status: "ongoing", code: "S103" },
    { id: 3, name: "HCI UI/UX Challenge 02", status: "ongoing", code: "S104" },
    { id: 4, name: "Graph Assignment 02", status: "ongoing", code: "S105" },
    { id: 5, name: "HCI UI/UX Challenge 01", status: "ongoing", code: "S106" },
  ];
  ...
  return (
    <div>
      <Helmet>
        <title>Testify - Ongoing Exams</title>
      </Helmet>
      <PageHeader
        title="All Exams"
        breadcrumbs={[
