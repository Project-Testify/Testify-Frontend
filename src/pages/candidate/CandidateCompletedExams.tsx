...
export const CandidateCompletedExams = () => {
  const exams = [
    { id: 1, name: "Compiler Theory Flex & Bison", status: "completed", code: "S102" },
    { id: 2, name: "Machine Learning - Quiz 3", status: "completed", code: "S103" },
    { id: 3, name: "HCI UI/UX Challenge 02", status: "completed", code: "S104" },
    { id: 4, name: "Graph Assignment 02", status: "completed", code: "S105" },
